...
from typing import Dict, List, Tuple, Optional, Any, Union, TypeVar, Type
...
def setup(require_custom_config: bool = False, config_path: Optional[str] = None) -> Optional[List[str]]:
...
class ExtensionError(FrameworkError):
    ...
    def __init__(self, name: str, install_command: Union[str, List[str]]) -> None:
        global config
